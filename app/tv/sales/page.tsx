...
export default async function TVSalesPage({
      ...
      <html lang="en">
        <body style={{ margin: 0, background: "#09090b", color: "#fafafa", fontFamily: "system-ui, -apple-system, sans-serif", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#71717a", fontSize: "1.125rem" }}>Invalid or missing access key.</p>
          </div>
        </body>
      </html>
    );
  ...
  return (
    <html lang="en">
      <head>
        {/* Auto-refresh every 10 seconds to cycle periods and get fresh data */}
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .hero-amount {
            ...
            line-height: 1;
            background: linear-gradient(180deg, #fafafa 60%, rgba(250,250,250,0.3) 100%);
          ...
          .live-text { font-size: 12px; color: #71717a; }
          ...
          .panel-header .period { font-size: 14px; color: #71717a; font-weight: 400; }
          .panel-body {
            padding: 16px;
            max-height: 420px;
            overflow-y: auto;
          ...
          .lb-name.top { font-size: 16px; }
          .lb-deals { font-size: 12px; color: #71717a; margin-top: 2px; }
          .lb-amount {
            font-weight: 700;
            font-variant-numeric: tabular-nums;
            flex-shrink: 0;
          }
          .lb-amount.top { font-size: 18px; }
          .lb-amount.other { font-size: 14px; color: rgba(250,250,250,0.7); }
          ...
          .deal-meta { font-size: 12px; color: #71717a; margin-top: 2px; }
          .deal-amount {
            font-weight: 700;
            font-size: 16px;
            font-variant-numeric: tabular-nums;
          ...
          .stat-value { font-size: 14px; font-weight: 600; color: rgba(255,255,255,0.5); }
          .stat-deals { font-size: 12px; color: rgba(255,255,255,0.25); }
          ...
          {allTotals && (
            <div className="bottom-stats">
              ...
              {totals.average_deal > 0 && (
                <div className="stat-item" style={{ paddingLeft: 16, borderLeft: "1px solid rgba(255,255,255,0.06)" }}>
