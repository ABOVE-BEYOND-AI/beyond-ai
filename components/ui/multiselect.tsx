  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative min-h-[56px] w-full rounded-lg border border-border/60 bg-background text-base ring-offset-background placeholder:text-muted-foreground/50 focus-within:border-primary/60 disabled:cursor-not-allowed disabled:opacity-50",
            {
        ...
        >
          <div className="flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "flex-1 bg-transparent outline-none border-none ring-0 placeholder:text-muted-foreground/50 disabled:cursor-not-allowed focus-visible:outline-none focus:outline-none focus:ring-0 focus:border-none focus-visible:border-none",
                {
            ...
            <button
              ...
              className={cn(
                "absolute end-0 top-0 flex size-14 items-center justify-center rounded-lg border border-transparent text-muted-foreground/80 transition-colors hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70",
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
